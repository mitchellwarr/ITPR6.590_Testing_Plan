...
# start H2
java -cp h2-1.4.192.jar -Duser.home="$dbhome" -Dh2.baseDir="$dbhome" -Dh2.bindAddress=localhost org.h2.tools.Console -tcp -tcpPort $db_port -web -webPort $web_port -tool
